...
use Sergo\ArtGallery\Entity\NFTArt;
...
use Sergo\ArtGallery\Service\ArrivalNewPictureService\NewNFTArtDto;
...
class ArrivalNewPictureService
{
    ...
    public function registerPicture(NewPictureDto $newPictureDto): ResultRegisteringPictureDto
    {
        ...
        if ($newPictureDto instanceof NewNFTArtDto) {
            $entity = new NFTArt(
                $newPictureDto->getNFTToken(),
