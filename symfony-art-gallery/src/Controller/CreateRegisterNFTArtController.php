...
class CreateRegisterNFTArtController extends AbstractController
{
    /**
    ...
    {
        $requestDto = new ArrivalNewPictureService\NewNFTArtDto(
            $requestData['name'],
            ...
            new Assert\Collection(
                [
                    ...
                    'fields'               => [
                        ...
                        'token'       => [
                            new Assert\Type(
                                ['type' => 'string', 'message' => 'NFT Token должен быть строкой']
                            ),
                            new Assert\NotBlank(['message' => 'NFT Token отсутствует', 'normalizer' => 'trim'])
                        ],
                    ]
                ]
            )
