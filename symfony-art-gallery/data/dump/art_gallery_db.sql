...
ALTER TABLE ONLY public.tags_to_pictures DROP CONSTRAINT tag_id_fk;
ALTER TABLE ONLY public.exchange_info DROP CONSTRAINT second_purchase_price_id_fk;
...
ALTER TABLE ONLY public.tags_to_pictures DROP CONSTRAINT picture_id_fk;
ALTER TABLE ONLY public.exchange_info DROP CONSTRAINT first_purchase_price_id_fk;
...
DROP INDEX public.tags_name_unq;
...
ALTER TABLE ONLY public.tags_to_pictures DROP CONSTRAINT tags_to_pictures_pkey;
...
ALTER TABLE ONLY public.exchange_info DROP CONSTRAINT exchange_info_pkey;
...
DROP TABLE public.tags_to_pictures;
...
DROP TABLE public.exchange_info;
...
--
-- Name: exchange_info; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.exchange_info (
    id integer NOT NULL,
    first_purchase_id integer,
    second_purchase_id integer
);


ALTER TABLE public.exchange_info OWNER TO postgres;

--
-- Name: exchange_info_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.exchange_info ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.exchange_info_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: tags_to_pictures; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tags_to_pictures (
    picture_id integer NOT NULL,
    tag_id integer NOT NULL
);


ALTER TABLE public.tags_to_pictures OWNER TO postgres;
...
--
-- Name: exchange_info exchange_info_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.exchange_info
    ADD CONSTRAINT exchange_info_pkey PRIMARY KEY (id);
...
--
-- Name: tags_to_pictures tags_to_pictures_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tags_to_pictures
    ADD CONSTRAINT tags_to_pictures_pkey PRIMARY KEY (picture_id, tag_id);
...
--
-- Name: tags_name_unq; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX tags_name_unq ON public.tags USING btree (name);
...
--
-- Name: exchange_info first_purchase_price_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.exchange_info
    ADD CONSTRAINT first_purchase_price_id_fk FOREIGN KEY (first_purchase_id) REFERENCES public.picture_purchase_reports(id);


--
-- Name: tags_to_pictures picture_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tags_to_pictures
    ADD CONSTRAINT picture_id_fk FOREIGN KEY (picture_id) REFERENCES public.pictures(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: exchange_info second_purchase_price_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.exchange_info
    ADD CONSTRAINT second_purchase_price_id_fk FOREIGN KEY (second_purchase_id) REFERENCES public.picture_purchase_reports(id);


--
-- Name: tags_to_pictures tag_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tags_to_pictures
    ADD CONSTRAINT tag_id_fk FOREIGN KEY (tag_id) REFERENCES public.tags(id) ON UPDATE CASCADE ON DELETE CASCADE;
